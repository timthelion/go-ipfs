...
var ErrNotFound = fmt.Errorf("merkledag: not found. Is the ipfs daemon running? The daemon must be running in order to get non-local merkeldags. Launch it with \"ipfs daemon\".")
